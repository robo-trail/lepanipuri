...
class BiSO101Follower(Robot):
    ...
    This bimanual robot can also be easily adapted to use SO-101 follower arms, just replace the SO101Follower class with SO101Follower and SO101FollowerConfig with SO101FollowerConfig.
    """
