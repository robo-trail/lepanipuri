...
class BiSO101Leader(Teleoperator):
    """
    [Bimanual SO-101 Leader Arms](https://github.com/TheRobotStudio/SO-ARM101) designed by TheRobotStudio
    This bimanual leader arm can also be easily adapted to use SO-101 leader arms, just replace the SO101Leader class with SO101Leader and SO101LeaderConfig with SO101LeaderConfig.
    """
